...
export default function CasesDashboard() {
  ...
  return <main className="ops-page staff-page">
    ...
    <section className="admin-auth-panel"><label><span>كلمة مرور الإدارة</span><input type="password" value={password} onChange={(e)=>setPassword(e.target.value)} /></label><button onClick={loadCases} disabled={loading}>{loading ? "جاري العمل..." : "تحميل الحالات"}</button><p className={`ops-notice ops-notice-${notice.type}`}>{notice.text}</p></section>
